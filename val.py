...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/data1/argoverse2/')
    ...
    parser.add_argument('--ckpt_path', type=str, default='~/Multi-agent-competitive-environment/checkpoints/epoch=19-step=499780.ckpt')
